...
public class OneDollarShop2 {
	 ...
	 */
	OneDollarShop2(String storeName, String businessHours) {
	...
	/**
	 * 親会社名設定メソッド		セッタ
	 * @param parentCompany 親会社名
	 */
	public static void setParentCompany(String parentCompany) {
		OneDollarShop2.parentCompany = parentCompany; //新しく親会社名を設定できる CanYou
	}
